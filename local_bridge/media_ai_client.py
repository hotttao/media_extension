...
_logger.remove()
_LOG_FILE = pathlib.Path("logs/media_ai_client.log")
...
class MediaAIClient:
    ...
    def build_model_image_task(
        ...
        _logger.debug("build_model_image_task downloading assets ip_url={ip_url} main_url={main_url}", ip_url=ip_url, main_url=main_url)
