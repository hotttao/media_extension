...
| POST | `/api/products/{id}/images` | POST products id images | [View](../operations/postProductsIdImages.md) |
| POST | `/api/products/{id}/model-image` | POST products id model image | [View](../operations/postProductsIdModelImage.md) |
| POST | `/api/products/{id}/model-image/save` | POST products id model image save | [View](../operations/postProductsIdModelImageSave.md) |
| GET | `/api/products/{id}/model-images` | GET products id model images | [View](../operations/getProductsIdModelImages.md) |
